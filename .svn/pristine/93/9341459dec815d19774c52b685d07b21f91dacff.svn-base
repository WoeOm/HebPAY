...
public interface JFPayDAO {
	 ...
	 * @return
	 */
	int insertJfPayorder(String orderNo, int cantonid, int unitid,String payerName, int payertypeid,String busiTypeCode, double amt, String OrderDate);
	/**
	 * 更新缴费平台订单表
	 * @param unitid 单位id
